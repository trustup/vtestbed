model tankmodel
  ...
  Modelica.Blocks.Logical.Timer timer annotation(
    Placement(visible = true, transformation(origin = {-63, 97}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
...
equation
  ...
  connect(timer.u, not2.y) annotation(
    Line(points = {{-69, 97}, {-66, 97}, {-66, 82}, {-68, 82}}, color = {255, 0, 255}));
